...
# Repository: https://github.com/edinoconntrack_Wizard
...
# A simple way to execute this script is using the following command: curl -s https://raw.githubusercontent.com/edinoconntrack_Wizard/mainconntrack_wizard.py | python3 -
...
def main():
    ...
    try:
        conntrack_command = input("\nEnter conntrack command: ").upper()
        ...
        output_directory = input("\nEnter the directory where the file will be saved (press Enter for default /var/): ")
